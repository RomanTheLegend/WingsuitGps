...
public:
  ...
  void display()
  {
    ...
    GhudDevice::displayString("3619", 0x77, 120, 10);
...
private:
  ...
  volatile int comp_mode_random_speed;
  ...
  void checkLane()
  {
    ...
    if (GpsInterface::getStartDp().isValid){
      ...
      GhudDevice::displayString("Lane lock in ", 0x77, 100, 150);
      GhudDevice::displayString("9", 0x77, 150, 150); // 10 - secondsSinceExit
      GhudDevice::drawArrow(100, 140, 0);
    }
